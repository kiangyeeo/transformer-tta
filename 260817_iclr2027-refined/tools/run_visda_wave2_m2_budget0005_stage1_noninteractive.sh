...
# VisDA-C Wave-2 Stage-1 grid at budget=0.0005 and omega=0.00625.
...
PLAN_PATH="$SEARCH_ROOT/plans/wave2_m2_stage1_budget0005/plan.json"
RUNS_ROOT="$SEARCH_ROOT/runs"
LOGS_ROOT="$SEARCH_ROOT/launcher_logs/wave2_m2_stage1_budget0005"
COMMAND_HISTORY="$SEARCH_ROOT/command_history/wave2_m2_stage1_budget0005_commands.sh"
