#!/usr/bin/env python3
"""Build and CPU-verify Node 7's frozen Office out-channel R2 cell."""
...
PLAN_PATH = PROJECT_ROOT / "experiment_logs/conv_lbi_r2_out_32gpu_20260828/plans/node7_omega_0p1__lr_0p01.jsonl"
...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1] == "--verify-existing":
        ...
        raise SystemExit("usage: prepare_conv_lbi_r2_out_node7.py [--verify-existing]")
    print(json.dumps({
