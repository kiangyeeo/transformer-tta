#!/usr/bin/env python3
"""Build and CPU-verify Node 6's frozen Office out-channel R2 cell."""
...
PLAN_PATH = PROJECT_ROOT / "experiment_logs/conv_lbi_r2_out_32gpu_20260828/plans/node6_omega_0p1__lr_0p005.jsonl"
...
def validate_entries(entries):
    ...
    for entry in entries:
        ...
        require((entry["omega"], entry["stage2_lr"]) != CENTRAL_CELL, "central cell was scheduled")
...
def main():
    ...
    if len(sys.argv) == 2 and sys.argv[1] == "--verify-existing":
        ...
        raise SystemExit("usage: prepare_conv_lbi_r2_out_node6.py [--verify-existing]")
    print(json.dumps({
