...
# Foreground, non-interactive executor for exactly seven new Wave-3 M2 rows.
...
PLAN_PATH="$SEARCH_ROOT/plans/wave3_m2_budget0005_A6_final_joint/plan.json"
PLAN_SHA256="b4084949601b1fd49aeb33915dad3511f683fe4817537452c37b2db666cff904"
RUNS_ROOT="$SEARCH_ROOT/runs"
LOGS_ROOT="$SEARCH_ROOT/launcher_logs/wave3_m2_budget0005_A6_final_joint"
COMMAND_HISTORY="$SEARCH_ROOT/command_history/wave3_m2_budget0005_A6_final_joint_commands.sh"
...
# Stay attached until every planned identity has completed. The runner skips
