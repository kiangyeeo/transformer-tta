...
# 11. NODE-SPECIFIC ASSIGNMENT — node1

```text
CONTROL_ROOT = /inspire/hdd/global_user/gaoyachen-253308310317/PJ/Split-LBI/260817_iclr2027-refined/experiment_logs/visda_conv_lbi_v1j_out_joint_sweep_seed2026_20260830/control/node1
RUNS_ROOT    = /inspire/hdd/global_user/gaoyachen-253308310317/PJ/Split-LBI/260817_iclr2027-refined/experiment_logs/visda_conv_lbi_v1j_out_joint_sweep_seed2026_20260830/runs/node1
ASSIGNED_RUN_COUNT = 6
```
...
|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 0 | 1 | `J_B2_W2_L2` | 0.002 | 18 | 0.050 | 1 | 1.00 | 0.00625 | 0.01 |
| 0 | 2 | `J_B1_W0_L0` | 0.001 | 9 | 0.025 | 1 | 0.50 | 0.0015625 | 0.0025 |
| 1 | 1 | `J_B0_W0_L0` | 0.0005 | 4 | 0.025 | 1 | 0.50 | 0.0015625 | 0.0025 |
| 1 | 2 | `J_B2_W2_L0` | 0.002 | 18 | 0.050 | 1 | 1.00 | 0.00625 | 0.0025 |
| 2 | 1 | `J_B1_W0_L2` | 0.001 | 9 | 0.025 | 1 | 0.50 | 0.0015625 | 0.01 |
| 3 | 1 | `J_B2_W0_L1` | 0.002 | 18 | 0.050 | 1 | 1.00 | 0.0015625 | 0.005 |

Exact per-GPU chains:

```text
GPU0: J_B2_W2_L2 -> J_B1_W0_L0
GPU1: J_B0_W0_L0 -> J_B2_W2_L0
GPU2: J_B1_W0_L2
GPU3: J_B2_W0_L1
```
...
```text
experiment_logs/visda_conv_lbi_v1j_out_joint_sweep_seed2026_20260830/control/node1/run_node_4gpu.sh
```
...
bash experiment_logs/visda_conv_lbi_v1j_out_joint_sweep_seed2026_20260830/control/node1/run_node_4gpu.sh
```
