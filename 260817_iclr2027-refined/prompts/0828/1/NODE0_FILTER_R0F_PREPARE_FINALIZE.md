...
|---:|---|---:|---:|---:|---:|
| 1 | F0 | 0.25 | 0.5 | .0005 | 3276 |
| 2 | F1 | 0.3 | 0.5 | .0005 | 3276 |
| 3 | F2 | 0.4 | 0.5 | .0005 | 3276 |
| 4 | F3 | 0.6 | 0.5 | .0005 | 3276 |
...
```text
plan:
experiment_logs/conv_lbi_32gpu_burst_20260827/plans/node0_filter_r0f.jsonl

launcher:
tools/run_conv_lbi_32gpu_node0_filter_r0f.sh

prepare record:
experiment_logs/conv_lbi_32gpu_burst_20260827/node_records/node0_filter_r0f_PREPARE.md
...
9. Run static checks only:
   ...
   - uniqueness checks;
   - `bash -n tools/run_conv_lbi_32gpu_node0_filter_r0f.sh`;
   - `git diff --check`.
...
12. Print only:
   ...
   bash tools/run_conv_lbi_32gpu_node0_filter_r0f.sh
   ```
13. Stop.
...
Node 1 owns the combined `.0005` budget selection after both halves finish.


End with:
```text
NODE0_FINALIZE_COMPLETE: YES/NO
PLANNED: 4
COMPLETED: X
FAILED: X
MISSING: X
