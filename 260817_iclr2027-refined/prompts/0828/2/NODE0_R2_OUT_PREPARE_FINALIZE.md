...
|---:|---|---:|---:|---:|---:|---|---:|---:|---:|---:|
| 1 | AD | 0 | 1 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 2 | AW | 0 | 2 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 3 | DA | 1 | 0 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 4 | DW | 1 | 2 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 5 | WA | 2 | 0 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 6 | WD | 2 | 1 | 0.0005 | 4 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 7 | AD | 0 | 1 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 8 | AW | 0 | 2 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 9 | DA | 1 | 0 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 10 | DW | 1 | 2 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 11 | WA | 2 | 0 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 12 | WD | 2 | 1 | 0.001 | 9 | A1 | 0.05 | 0.5 | 0.00625 | 0.0025 |
| 13 | AD | 0 | 1 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |
| 14 | AW | 0 | 2 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |
| 15 | DA | 1 | 0 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |
| 16 | DW | 1 | 2 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |
| 17 | WA | 2 | 0 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |
| 18 | WD | 2 | 1 | 0.002 | 18 | A4 | 0.1 | 1 | 0.00625 | 0.0025 |

## Exact artifact paths for this node

Branch output root passed via `--output-root`:
```text
experiment_logs/office_conv_lbi_r2_out_joint_sweep_seed2026_20260828/runs/omega_0p00625__lr_0p0025
```
...
Plan:
```text
experiment_logs/conv_lbi_r2_out_32gpu_20260828/plans/node0_omega_0p00625__lr_0p0025.jsonl
```

Optional generated per-row configs, if the existing plan builder uses them:
```text
experiment_logs/conv_lbi_r2_out_32gpu_20260828/plans/node0_omega_0p00625__lr_0p0025_configs/
```

Launcher:
```text
tools/run_conv_lbi_r2_out_node0.sh
```
...
FINALIZE record:
```text
experiment_logs/conv_lbi_r2_out_32gpu_20260828/node_records/node0_FINALIZE.md
```
...
9. Verify before writing PREPARE:
   ...
   - all rows have exactly `omega=0.00625`, `stage2_lr=0.0025`;
...
12. Run only static/CPU checks:
   ...
   bash -n tools/run_conv_lbi_r2_out_node0.sh
   git diff --check
   ```
13. Do NOT launch training and do NOT probe GPUs.
14. Write `experiment_logs/conv_lbi_r2_out_32gpu_20260828/node_records/node0_PREPARE.md` with:
...
bash tools/run_conv_lbi_r2_out_node0.sh
```
16. Stop.
...
10. Write `experiment_logs/conv_lbi_r2_out_32gpu_20260828/node_records/node0_FINALIZE.md`.
11. End with exactly:
```text
NODE0_R2_FINALIZE_COMPLETE: YES/NO
CELL: omega_0p00625__lr_0p0025
PLANNED: 18
COMPLETED: X
FAILED: X
MISSING: X
