...
```text
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node0/
```
...
|---|---:|---:|---:|---:|---:|
| V0000 | 0 | 0.0005 | 4 | 0.05 | 0.5 |
| V0001 | 1 | 0.0005 | 4 | 0.025 | 0.5 |
| V0002 | 2 | 0.0005 | 4 | 0.1 | 0.5 |
| V0003 | 3 | 0.0005 | 4 | 0.05 | 0.25 |
...
all rows are exactly NODE 0's allowlisted matrix
runtime_comparable=false
```
...
bash experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node0/run_node0_4gpu.sh
```
...
```text
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node0/NODE_FINALIZE.md
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node0/node_rows.csv
```
