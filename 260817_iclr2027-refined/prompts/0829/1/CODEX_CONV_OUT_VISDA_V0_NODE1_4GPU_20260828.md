...
```text
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node1/
```
...
|---|---:|---:|---:|---:|---:|
| V0004 | 0 | 0.0005 | 4 | 0.05 | 1 |
| V0010 | 1 | 0.001 | 9 | 0.05 | 0.5 |
| V0011 | 2 | 0.001 | 9 | 0.025 | 0.5 |
| V0012 | 3 | 0.001 | 9 | 0.1 | 0.5 |
...
all rows are exactly NODE 1's allowlisted matrix
runtime_comparable=false
```
...
bash experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node1/run_node1_4gpu.sh
```
...
```text
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node1/NODE_FINALIZE.md
experiment_logs/visda_conv_lbi_v0_out_stage1_seed2026_20260828/node1/node_rows.csv
```
