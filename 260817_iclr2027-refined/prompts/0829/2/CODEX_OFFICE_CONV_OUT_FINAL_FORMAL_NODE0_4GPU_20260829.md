...
# NODE-SPECIFIC ASSIGNMENT — node0

Node root:

```text
/inspire/hdd/global_user/gaoyachen-253308310317/PJ/Split-LBI/260817_iclr2027-refined/experiment_logs/office_conv_lbi_final_formal_out_channel_seed2026_20260829/control/node0
```
...
This node must create **exactly 5 formal rows**.
...
- GPU0 has exactly two sequential `.0005` runs on this node.
- The second GPU0 run starts only after the first exits successfully.
...
```text
<NODE_ROOT> = /inspire/hdd/global_user/gaoyachen-253308310317/PJ/Split-LBI/260817_iclr2027-refined/experiment_logs/office_conv_lbi_final_formal_out_channel_seed2026_20260829/control/node0
<RUNS_ROOT> = /inspire/hdd/global_user/gaoyachen-253308310317/PJ/Split-LBI/260817_iclr2027-refined/experiment_logs/office_conv_lbi_final_formal_out_channel_seed2026_20260829/runs/node0
```
