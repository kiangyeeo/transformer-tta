...
|---:|---|---:|---:|---:|---:|
| 1 | F0 | 0.25 | 0.5 | .002 | 13107 |
| 2 | F1 | 0.3 | 0.5 | .002 | 13107 |
| 3 | F2 | 0.4 | 0.5 | .002 | 13107 |
| 4 | F3 | 0.6 | 0.5 | .002 | 13107 |
...
```text
plan:
experiment_logs/conv_lbi_32gpu_burst_20260827/plans/node4_filter_r0f.jsonl

launcher:
tools/run_conv_lbi_32gpu_node4_filter_r0f.sh

prepare record:
experiment_logs/conv_lbi_32gpu_burst_20260827/node_records/node4_filter_r0f_PREPARE.md
...
9. Run static checks only:
   ...
   - uniqueness checks;
   - `bash -n tools/run_conv_lbi_32gpu_node4_filter_r0f.sh`;
   - `git diff --check`.
...
12. Print only:
   ...
   bash tools/run_conv_lbi_32gpu_node4_filter_r0f.sh
   ```
13. Stop.
...
Node 5 owns the combined `.002` budget selection after both halves finish.


End with:
```text
NODE4_FINALIZE_COMPLETE: YES/NO
PLANNED: 4
COMPLETED: X
FAILED: X
MISSING: X
