# Office LBI Final Joint Sweep — Machine 3
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/matrices/machine3/
```
...
|---:|---:|---|---:|---:|---:|
| 0.002 | 1049 | A2 | 0.15 | 1.0 | 0.50 |
| 0.002 | 1049 | A3 | 0.20 | 1.0 | 0.50 |
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/plans/machine3/plan.json
```
...
```text
tools/run_office_lbi_joint_sweep_machine3_noninteractive.sh
```
...
bash tools/run_office_lbi_joint_sweep_machine3_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/locks/machine3.lock
```
...
```text
bash -n tools/run_office_lbi_joint_sweep_machine3_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/phase_records/machine3/PREPARE_READY.json
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/phase_records/machine3/PREPARE.md
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/reports/machine3/
```
...
```text
FINALIZE complete for machine3.
