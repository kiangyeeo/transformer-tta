...
3. Create `tools/run_visda_wave3_m2_budget0005_A6_final_joint_noninteractive.sh`.
4. Static checks only: plan uniqueness, `bash -n`, `git diff --check`.
5. Write `${SEARCH_ROOT}/phase_records/wave3_m2/PREPARE.md`.
...
Write `${SEARCH_ROOT}/phase_records/wave3_m2/FINALIZE.md`.
