# Office Night Machine 1 — Baselines A→D/A→W + LBI Stage-1 rho=0.0005
...
```text
Machine tag       : machine1
Baseline transfers: A->D, A->W
LBI Stage-1 budget: 0.0005
Integer K         : 262
```
...
```text
tools/run_office_night_machine1_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_seed2026_stage1_20260818/phase_records/machine1/PREPARE.md
```
...
```text
bash -n tools/run_office_night_machine1_noninteractive.sh
planner dry-run
launcher dry-run
...
bash tools/run_office_night_machine1_noninteractive.sh
```
...
$$
u_t=\frac{\mathrm{selected\_count}_t}{262}
$$

and:

$$
budget\_gap_t=262-\mathrm{selected\_count}_t.
$$
...
```text
results/baseline/machine1/
results/lbi_stage1/budget_0005/

reports/machine1/baseline_summary.csv
reports/machine1/baseline_summary.json
reports/machine1/baseline_summary.md

reports/machine1/stage1_per_run.csv
reports/machine1/stage1_candidate_ranking.csv
reports/machine1/stage1_candidate_ranking.json
reports/machine1/stage1_candidate_ranking.md
reports/machine1/stage1_selection.json
```
...
```text
experiment_logs/shot_otta_office_seed2026_stage1_20260818/phase_records/machine1/FINALIZE.md
```
...
```text
FINALIZE complete for machine1 / budget 0.0005.
