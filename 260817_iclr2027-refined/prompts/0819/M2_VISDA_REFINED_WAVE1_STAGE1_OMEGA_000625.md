...
# Machine 2 — Refined VisDA budget-0.001 Stage-1 grid at omega=0.00625
...
```text
${SEARCH_ROOT}/matrices/wave1_m2_stage1_budget001_omega_000625/matrix.yaml
${SEARCH_ROOT}/plans/wave1_m2_stage1_budget001_omega_000625/
```
...
```text
260817_iclr2027-refined/tools/run_visda_wave1_m2_stage1_omega_000625_noninteractive.sh
```
...
```bash
bash -n 260817_iclr2027-refined/tools/run_visda_wave1_m2_stage1_omega_000625_noninteractive.sh
git diff --check
```
...
```text
${SEARCH_ROOT}/phase_records/wave1_m2/PREPARE.md
```
...
bash 260817_iclr2027-refined/tools/run_visda_wave1_m2_stage1_omega_000625_noninteractive.sh
```
...
Run only after the Machine-2 launcher returns.
...
```text
${SEARCH_ROOT}/phase_records/wave1_m2/FINALIZE.md
```
