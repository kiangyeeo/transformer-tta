# Office Night Machine 3 — Baselines W→A/W→D + LBI Stage-1 rho=0.002
...
```text
Machine tag       : machine3
Baseline transfers: W->A, W->D
LBI Stage-1 budget: 0.002
Integer K         : 1049
```
...
```text
tools/run_office_night_machine3_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_seed2026_stage1_20260818/phase_records/machine3/PREPARE.md
```
...
```text
bash -n tools/run_office_night_machine3_noninteractive.sh
planner dry-run
launcher dry-run
...
bash tools/run_office_night_machine3_noninteractive.sh
```
...
$$
u_t=\frac{\mathrm{selected\_count}_t}{1049}
$$

and:

$$
budget\_gap_t=1049-\mathrm{selected\_count}_t.
$$
...
```text
results/baseline/machine3/
results/lbi_stage1/budget_002/

reports/machine3/baseline_summary.csv
reports/machine3/baseline_summary.json
reports/machine3/baseline_summary.md

reports/machine3/stage1_per_run.csv
reports/machine3/stage1_candidate_ranking.csv
reports/machine3/stage1_candidate_ranking.json
reports/machine3/stage1_candidate_ranking.md
reports/machine3/stage1_selection.json
```
...
```text
experiment_logs/shot_otta_office_seed2026_stage1_20260818/phase_records/machine3/FINALIZE.md
```
