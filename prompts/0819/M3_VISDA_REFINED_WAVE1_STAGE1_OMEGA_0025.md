...
# Machine 3 — Refined VisDA budget-0.001 Stage-1 grid at omega=0.025
...
```text
${SEARCH_ROOT}/matrices/wave1_m3_stage1_budget001_omega_0025/matrix.yaml
${SEARCH_ROOT}/plans/wave1_m3_stage1_budget001_omega_0025/
```
...
```text
260817_iclr2027-refined/tools/run_visda_wave1_m3_stage1_omega_0025_noninteractive.sh
```
...
```bash
bash -n 260817_iclr2027-refined/tools/run_visda_wave1_m3_stage1_omega_0025_noninteractive.sh
git diff --check
```
...
```text
${SEARCH_ROOT}/phase_records/wave1_m3/PREPARE.md
```
...
bash 260817_iclr2027-refined/tools/run_visda_wave1_m3_stage1_omega_0025_noninteractive.sh
```
...
Run only after the Machine-3 launcher returns.
...
```text
${SEARCH_ROOT}/phase_records/wave1_m3/FINALIZE.md
```
