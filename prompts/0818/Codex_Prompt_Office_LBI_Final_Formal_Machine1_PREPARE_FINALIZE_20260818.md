# Office LBI Final Formal Evaluation — Machine 1 — Budget 0.0005
...
Verify that budget `0.0005` is frozen exactly as:
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/matrices/machine1/
```
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/plans/machine1/plan.json
```
...
```text
tools/run_office_lbi_final_formal_budget_0005_noninteractive.sh
```
...
bash tools/run_office_lbi_final_formal_budget_0005_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/locks/machine1.lock
```
...
```text
bash -n tools/run_office_lbi_final_formal_budget_0005_noninteractive.sh
git diff --check
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/phase_records/machine1/PREPARE_READY.json
```
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/phase_records/machine1/PREPARE.md
```
...
```text
experiment_logs/shot_otta_office_lbi_final_formal_20260818/reports/machine1/
```
