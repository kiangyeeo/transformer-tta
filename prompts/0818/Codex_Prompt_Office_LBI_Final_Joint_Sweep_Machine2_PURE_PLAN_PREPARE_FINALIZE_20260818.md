# Office LBI Final Joint Sweep — Machine 2
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/matrices/machine2/
```
...
|---:|---:|---|---:|---:|---:|
| 0.001 | 524 | A6 | 0.10 | 1.0 | 0.25 |
| 0.001 | 524 | A4 | 0.10 | 1.5 | 0.50 |
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/plans/machine2/plan.json
```
...
```text
tools/run_office_lbi_joint_sweep_machine2_noninteractive.sh
```
...
bash tools/run_office_lbi_joint_sweep_machine2_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/locks/machine2.lock
```
...
```text
bash -n tools/run_office_lbi_joint_sweep_machine2_noninteractive.sh
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/phase_records/machine2/PREPARE_READY.json
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/phase_records/machine2/PREPARE.md
```
...
```text
experiment_logs/shot_otta_office_lbi_joint_sweep_20260818/reports/machine2/
```
...
```text
FINALIZE complete for machine2.
