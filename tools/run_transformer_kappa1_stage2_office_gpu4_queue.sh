...
# Original GPU4 slice of the frozen Office-31 rho=.002 Stage-2 plan.
...
LAUNCH_ROOT="$LAUNCH_PARENT/gpu4_${STAMP}"
GPU=4
...
QUEUE=(
  'C01|0.05|0.005|webcam|amazon'
  'C03|0.05|0.020|amazon|dslr'
  'C04|0.10|0.005|dslr|amazon'
  'C05|0.10|0.010|webcam|amazon'
  'C07|0.20|0.005|amazon|dslr'
  'C08|0.20|0.010|dslr|amazon'
  'C09|0.20|0.020|webcam|amazon'
  'C11|0.30|0.010|amazon|dslr'
  'C12|0.30|0.020|dslr|amazon'
)
...
ln -sfn "$LAUNCH_ROOT" "$LAUNCH_PARENT/latest_gpu4"
