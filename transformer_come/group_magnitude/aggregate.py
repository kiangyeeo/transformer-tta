"""Aggregate COME Group-Magnitude budgets using SHOT aggregation semantics."""

from __future__ import annotations

from pathlib import Path

from transformer.group_magnitude.aggregate import (
...
def aggregate_matrix(run_root: Path, *, transfers=TRANSFERS, budgets=FORMAL_BUDGETS) -> dict:
    ...
    result["method"] = "come"
    result["protocol_revision"] = PROTOCOL_REVISIONS["group_magnitude"]
    result["implementation_revision"] = IMPLEMENTATION_REVISIONS["group_magnitude"]
    return result
