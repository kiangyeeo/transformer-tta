"""Load DeiT-S and expose the frozen controlled Magnitude candidate scope."""
...
def load_group_magnitude_model(config: dict, device):
    ...
    scope_record = {
        **scope_record,
        ...
        "selection_method": "source_w0_structural_group_l2",
    }
    return model, checkpoint_record, candidates, frozen, scope_record


__all__ = ["frozen_named_state", "hash_tensors", "load_group_magnitude_model"]
