"""Frozen configuration and transfer identity for candidate-dense SHOT-OTTA."""
...
PROTOCOL_REVISION = "transformer_candidate_dense_otta_20260822_v1"
...
CANDIDATE_SCALAR_COUNT = 5_308_416


def candidate_parameter_names() -> tuple[str, ...]:
    return tuple(
...
def resolve_transfer_config(
    ...
    *,
    ...
    resolved["experiment_key"] = (
        f"{dataset}_{source}-{target}_candidate-dense_seed-{FORMAL_SEED}_"
