"""Load DeiT-S and expose the exact controlled Group-LBI candidate tensors."""
...
def load_group_lbi_model(config: dict, device):
    ...
    scope_record = {
        **scope_record,
        ...
        "selection_method": "group_split_lbi",
    }
    return model, checkpoint_record, candidates, frozen, scope_record


__all__ = ["frozen_named_state", "hash_tensors", "load_group_lbi_model"]
